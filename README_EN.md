...
**A port of PasterDream to Minecraft 1.21.1 / NeoForge, formally authorized by the original author.**
...
The project **has received formal authorization from the original author, 异星之尘 (Aerolite_Dust)**, and is independently developed and maintained by the NPD team. See the [authorization screenshot](授权截图.jpg) in the repository root and the [copyright statement and authorization status](PERMISSIONS.md#english) for records, ownership, and specific usage scopes.
...
The full [copyright statement and authorization status](PERMISSIONS.md#english) documents formal authorization, ownership, and applicable licenses. Specific usage scopes follow actual authorization records and the terms governing each item.

Thanks to **异星之尘 (Aerolite_Dust)** and the original contributors for PasterDream's content and resources, and to the author for formally authorizing and supporting this project. Thanks to all [project contributors](https://github.com/LOVE-U987/NeoPasterDream1/graphs/contributors), [MomoNyako](https://www.mcmod.cn/author/40210.html), and [PhantomDaze](https://www.mcmod.cn/author/41210.html).
