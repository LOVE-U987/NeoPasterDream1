...
/**
 * 作物2a - 挖掘加速效果，仅可种植在染梦泥土/草方块上
 */
public class Crop2ABlock extends FlowerBlock {
    public Crop2ABlock(BlockBehaviour.Properties properties) {
        super(MobEffects.DIG_SPEED, 100, properties);
    }

    @Override
    public void entityInside(BlockState state, Level level, BlockPos pos, Entity entity) {
        if (entity instanceof LivingEntity living && !level.isClientSide) {
            living.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 100, 0, true, false));
        }
    }
