...
/**
 * 染梦树 1 号树叶装饰器（biome_dyedream_1_tree_leave_decorator）
 * <p>
 * 还原自原版 {@code net.pasterdream.world.features.treedecorators.BiomeDyedream1LeaveDecorator}，
 * 供 {@code data/pasterdream/worldgen/configured_feature/biome_dyedream_1_tree.json} 引用。
 * <p>
 ...
 */
public class BiomeDyedream1LeaveDecorator extends TreeDecorator {

    /** 无参装饰器编解码器（对照原版 Codec.unit，迁移为 MapCodec.unit） */
    public static final MapCodec<BiomeDyedream1LeaveDecorator> CODEC =
            MapCodec.unit(BiomeDyedream1LeaveDecorator::new);
    ...
    protected TreeDecoratorType<?> type() {
        return PDTreeDecorators.BIOME_DYEDREAM_1_TREE_LEAVE_DECORATOR.get();
    }
