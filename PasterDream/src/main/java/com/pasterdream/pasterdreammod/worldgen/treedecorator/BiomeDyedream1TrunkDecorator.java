...
/**
 * 染梦树 1 号树干装饰器（biome_dyedream_1_tree_trunk_decorator）
 * <p>
 * 还原自原版 {@code net.pasterdream.world.features.treedecorators.BiomeDyedream1TrunkDecorator}，
 ...
 */
public class BiomeDyedream1TrunkDecorator extends TreeDecorator {

    /** 无参装饰器编解码器（对照原版 Codec.unit，迁移为 MapCodec.unit） */
    public static final MapCodec<BiomeDyedream1TrunkDecorator> CODEC =
            MapCodec.unit(BiomeDyedream1TrunkDecorator::new);

    @Override
    protected TreeDecoratorType<?> type() {
        return PDTreeDecorators.BIOME_DYEDREAM_1_TREE_TRUNK_DECORATOR.get();
    }
