...
/**
 * 染梦树 2 号树叶装饰器（biome_dyedream_2_tree_leave_decorator）
 * <p>
 * 还原自原版 {@code net.pasterdream.world.features.treedecorators.BiomeDyedream2LeaveDecorator}，
 ...
 */
public class BiomeDyedream2LeaveDecorator extends TreeDecorator {

    /** 无参装饰器编解码器（对照原版 Codec.unit，迁移为 MapCodec.unit） */
    public static final MapCodec<BiomeDyedream2LeaveDecorator> CODEC =
            MapCodec.unit(BiomeDyedream2LeaveDecorator::new);
    ...
    protected TreeDecoratorType<?> type() {
        return PDTreeDecorators.BIOME_DYEDREAM_2_TREE_LEAVE_DECORATOR.get();
    }
