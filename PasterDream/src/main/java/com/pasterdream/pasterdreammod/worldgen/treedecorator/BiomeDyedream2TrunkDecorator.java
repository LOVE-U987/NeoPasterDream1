...
/**
 * 染梦树 2 号树干装饰器（biome_dyedream_2_tree_trunk_decorator）
 * <p>
 * 还原自原版 {@code net.pasterdream.world.features.treedecorators.BiomeDyedream2TrunkDecorator}，
 * 供 {@code data/pasterdream/worldgen/configured_feature/biome_dyedream_2_tree.json} 引用。
 * <p>
 ...
 */
public class BiomeDyedream2TrunkDecorator extends TreeDecorator {

    /** 无参装饰器编解码器（对照原版 Codec.unit，迁移为 MapCodec.unit） */
    public static final MapCodec<BiomeDyedream2TrunkDecorator> CODEC =
            MapCodec.unit(BiomeDyedream2TrunkDecorator::new);

    @Override
    protected TreeDecoratorType<?> type() {
        return PDTreeDecorators.BIOME_DYEDREAM_2_TREE_TRUNK_DECORATOR.get();
    }
