...
/**
 * 亚伦柯斯右手渲染器 (Aaroncos Righthand 0 Renderer)
 * <p>
 * 使用 {@link AaroncosRighthand0Model} 加载 GeckoLib 模型/纹理/动画。
...
public class AaroncosRighthand0Renderer extends GeoEntityRenderer<AaroncosRighthand0Entity> {
    ...
    @Override
    public RenderType getRenderType(AaroncosRighthand0Entity animatable, ResourceLocation texture,
                                    @Nullable MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, AaroncosRighthand0Entity entity, BakedGeoModel model,
