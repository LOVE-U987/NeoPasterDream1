...
public class AshBoneWingEntity extends Monster implements RangedAttackMob, GeoEntity {
    ...
    private static final EntityDataAccessor<Boolean> SHOOT =
            SynchedEntityData.defineId(AshBoneWingEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<String> ANIMATION =
            SynchedEntityData.defineId(AshBoneWingEntity.class, EntityDataSerializers.STRING);
     ...
     * @param level 世界实例
     */
    public AshBoneWingEntity(EntityType<AshBoneWingEntity> type, Level level) {
        super(type, level);
        this.xpReward = 12;
    ...
    protected void defineSynchedData(SynchedEntityData.@NotNull Builder builder) {
        ...
        builder.define(TEXTURE, "ash_bone_wing");
    }
    ...
    private PlayState procedurePredicate(AnimationState<AshBoneWingEntity> state) {
