 ...
 */
public class MeltdreamChestDisplayItem extends AbstractGeoDisplayItem {
     ...
     */
    public MeltdreamChestDisplayItem(Item.Properties properties) {
        super(PDBlocks.MELTDREAM_CHEST.get(), properties);
    }
