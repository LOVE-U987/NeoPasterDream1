 ...
 * <p>
 * 对应原版 {@code MeltdreamShovelItem}（属性与新模组既有 ItemAPI 注册逐项一致：
 * 耐久 250 / 挖速 6 / 伤害+4 / 攻速 -3.0 / 铁级不适用标签 / 附魔 5）。
...
public class MeltdreamShovelItem extends ShovelItem {
    ...
    private static final SimpleTier TIER = new SimpleTier(
            BlockTags.INCORRECT_FOR_IRON_TOOL, 250, 6.0f, 4.0f, 5,
     ...
     */
    public MeltdreamShovelItem(Properties properties) {
        // 原版 fireResistant；攻击伤害由 tier 承载（伤害参数 0，与 ItemAPI 方案一致）
        super(TIER, properties.fireResistant().attributes(ShovelItem.createAttributes(TIER, 0, -3.0f)));
    }
