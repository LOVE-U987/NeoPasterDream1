 ...
 */
public class UuzDoll0DisplayItem extends AbstractGeoDisplayItem {
     ...
     */
    public UuzDoll0DisplayItem(Item.Properties properties) {
        super(PDBlocks.LITTLE_PURPLE_DOLL_0.get(), properties);
    }
