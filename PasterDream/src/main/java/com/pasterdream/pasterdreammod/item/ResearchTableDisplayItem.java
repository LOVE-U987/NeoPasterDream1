...
/**
 * 研究台显示物品 (Research Table Display Item)
 * 使用 GeoItem 实现 3D 物品手持渲染（原版 item model 走
 * displaysettings/research_table.item 的 builtin/entity 路线）。
 * <p>
 * 客户端渲染器通过 {@code PDClientItemExtensions} 中的
 * {@code RegisterClientExtensionsEvent} 单独注册，避免服务端类加载。
 */
public class ResearchTableDisplayItem extends AbstractGeoDisplayItem {
     ...
     */
    public ResearchTableDisplayItem(Item.Properties properties) {
        super(PDBlocks.RESEARCH_TABLE.get(), properties);
    }
