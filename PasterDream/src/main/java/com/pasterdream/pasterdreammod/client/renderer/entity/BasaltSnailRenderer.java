 ...
 */
public class BasaltSnailRenderer extends GeoEntityRenderer<BasaltSnailEntity> {

    private static final String NAME = "basalt_snail";
     ...
     */
    public BasaltSnailRenderer(EntityRendererProvider.Context context) {
