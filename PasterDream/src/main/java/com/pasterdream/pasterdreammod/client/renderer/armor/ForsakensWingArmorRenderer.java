...
import com.pasterdream.pasterdreammod.client.model.armor.ForsakensWingModel;
...
/** 遗落之翼胸甲渲染器 */
public class ForsakensWingArmorRenderer extends GeoArmorRenderer<ForsakensWingItem> {

    public ForsakensWingArmorRenderer() {
