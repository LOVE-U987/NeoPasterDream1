 ...
 */
public class BlackBeetleRenderer extends GeoEntityRenderer<BlackBeetleEntity> {

    private static final String NAME = "black_beetle";
     ...
     */
    public BlackBeetleRenderer(EntityRendererProvider.Context context) {
